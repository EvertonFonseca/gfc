 ...
 * @author Windows
 */
public class VirtualModelApartacao<T> extends VirtualAbstractTableModel<T> {

    public VirtualModelApartacao(Web web, int row, String[] names, WTableView parent) {
        ...
        getTable().setItemDelegateForColumn(getIndexColuna("Editar"), new WAbstractItemDelegate() {
            ...
            public WWidget update(WWidget widget, WModelIndex index, EnumSet<ViewItemRenderFlag> flags) {
                ...
                btEdit.clicked().addListener(btEdit, (mouse) -> {
                    ...
                    MessageBox boxMessage = new MessageBox("Editar lote", "<p><p>Deseja realmente remover o lote " + getMap().get(index.getRow() + ":" + 1) + "?</p></p>");
            ...
            public WWidget update(WWidget widget, WModelIndex index, EnumSet<ViewItemRenderFlag> flags) {
                ...
                btRemove.clicked().addListener(btRemove, (mouse) -> {
                    ...
                    boxMessage.getEmitConfirmar().addListener(boxMessage, () -> {
                        ...
                        if (Apartacao_DAO.delete(Integer.parseInt(value))) {
