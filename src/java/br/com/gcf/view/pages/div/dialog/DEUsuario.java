 ...
 * @author Windows
 */
public class DEUsuario extends DialogAbstracao {
    ...
    public DEUsuario(Web web,Usuario_DTO usuario) {
        super("Editor Usuário");
...
//            this.usuario.setNome(Web.UTF8toISO(textNome.getText()));
//            this.usuario.setRacao(comboRacao.getSelecteObject());
//            this.usuario.setArroba(Double.parseDouble(textArroba.getText()));
//            this.usuario.setPesoDaCarcaca(Double.parseDouble(textCarcaca.getText()));
            
//            if (Lote_DAO.update(usuario)) {
//                
